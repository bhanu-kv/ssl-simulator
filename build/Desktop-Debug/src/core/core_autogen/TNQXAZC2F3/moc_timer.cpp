...
#include <memory>
#include "../../../../../../src/core/include/core/timer.h"
...
QT_MOC_LITERAL(1, 6, 14), // "scalingChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7) // "scaling"

    },
    "Timer\0scalingChanged\0\0scaling"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->scalingChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Timer::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::scalingChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Timer::scalingChanged(float _t1)
{
